...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1.0"},{"charset":"utf-8"}],"link":[],"style":[],"script":[],"noscript":[],"title":"PETRA SMP","viewport":"width=device-width, initial-scale=1.0"};
