<template>
  <div class="bg-[url(/background.jpg)] h-dvh bg-center bg-cover">
    <div class="backdrop-blur-sm h-dvh box-border place-items-center overflow-x-hidden">
      ...
      <a href="https://ko-fi.com/petragamingantivirus" class="display text-center font-inter text-4xl font-bold bg-clip-text bg-linear-to-r from-amber-600 to-yellow-200 text-transparent"><p>Kofi</p></a>
      <a href="https://patreon.com/petragaming" class="display text-center font-inter text-4xl font-bold bg-clip-text bg-linear-to-r from-amber-600 to-yellow-200 text-transparent"><p>Patreon</p></a>
      <br/>
